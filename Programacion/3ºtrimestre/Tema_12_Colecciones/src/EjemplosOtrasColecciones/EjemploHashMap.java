...
public class EjemploHashMap {
	public static void main(String[] args) {
		...
		miAgenda.put("564897845",new Persona (" 12345678A","Pepe","P�rez", LocalDate.of(1990,1,2 )));
		miAgenda.put ("654323121",new Persona (" 23456789B "," Juan ", " Mart�nez " , LocalDate.of( 1991,2,3 )));
		miAgenda.put ("987652541",new Persona (" 34567890C "," Ana ", " Ram�rez " , LocalDate.of( 1992,3,4)));
		Persona p=new Persona (" 45678901D "," Mar�a ", " L�pez " , LocalDate.of( 1993,4,5));
		miAgenda.put("789456123",p);
		//miAgenda.put("789456123",p);
		//miAgenda.put("789456123",p);
		miAgenda.put ("987652541",new Persona (" 34567890","Luisa", "S�nchez" , LocalDate.of( 1992,3,4)));
