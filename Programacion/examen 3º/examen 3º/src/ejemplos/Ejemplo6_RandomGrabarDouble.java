...
public class Ejemplo6_RandomGrabarDouble {
	...
	public static void main(String[] args) {
			...
			try {
				...
				System.out.print("A que numero de la lista quiere acceder?:");
				int posicion = in.nextInt();
				if(posicion >0 && posicion<=6) {
					miFicheroAleatorio.seek((posicion-1)*8);
					System.out.println("El numero que esta en la posicion "+posicion+" es "+miFicheroAleatorio.readDouble());
				}else 
